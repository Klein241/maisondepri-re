            ...
            >
                <Card className="border-none shadow-2xl bg-background/95 backdrop-blur-sm">
                    ...
                    <CardContent>
                        ...
                        <Button
                            variant="outline"
                            className="w-full h-12 mb-4 rounded-xl border-white/20 bg-white hover:bg-gray-50 text-gray-800 font-semibold text-sm shadow-sm"
                        ...
                        <div className="relative mb-4">
                            ...
                            <div className="relative flex justify-center text-xs">
                                <span className="bg-background px-3 text-muted-foreground">ou avec votre numéro</span>
                            </div>
                        </div>
