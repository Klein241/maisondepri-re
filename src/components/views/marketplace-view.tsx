                    ...
                    <div className="px-4 pt-4">
                        ...
                        <div className="mb-4">
                            ...
                            {selectedProduct.is_negotiable && (
                                <Badge className="mt-1 bg-amber-500/20 text-amber-400 text-[10px]">Prix négociable</Badge>
                            )}
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-3 mb-6">
                            ...
                            <Card className="bg-white/5 border-white/10">
                                <CardContent className="p-3">
                                    ...
                                    <p className="text-xs text-white mt-0.5">{selectedProduct.stock_quantity} disponible(s)</p>
                                </CardContent>
                            </Card>
