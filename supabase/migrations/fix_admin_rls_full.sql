-- ================================================================
-- ADMIN RLS POLICIES - FULL BACK-OFFICE ACCESS
-- ================================================================
-- This script grants admin users (profiles.role = 'admin') full
-- CRUD access to ALL tables needed for the back-office to function.
...
-- ==========================================
-- 1. PROFILES - Admin can manage ALL users
-- ==========================================
...
-- SELECT: Everyone can view profiles (needed for chat, groups, etc.)
...
-- ==========================================
-- 2. PRAYER_GROUPS - Admin can manage ALL groups
-- ==========================================
...
ON prayer_groups FOR SELECT TO authenticated
USING (true);

-- INSERT: Authenticated users can create (must be creator or admin)
CREATE POLICY "Users can create groups"
ON prayer_groups FOR INSERT TO authenticated
WITH CHECK (auth.uid() = created_by OR is_admin());

-- UPDATE: Creator, group admin, or app admin
...
ON prayer_group_members FOR SELECT TO authenticated
USING (true);

-- INSERT: Self-join, group admin add, or app admin
...
-- UPDATE: Group admin or app admin
...
-- DELETE: Self-leave, group admin, or app admin
...
-- ==========================================
-- 4. PRAYER_GROUP_MESSAGES - Admin full access
-- ==========================================
...
-- DELETE: Own messages, group admin, or app admin
...
-- ==========================================
-- 5. DIRECT_MESSAGES - Admin can moderate
-- ==========================================
...
-- ==========================================
-- 6. CONVERSATIONS - Admin can view all
-- ==========================================
...
-- ==========================================
-- 7. PRAYER_REQUESTS - Admin can manage
-- ==========================================
DO $$
BEGIN
...
-- ==========================================
-- 8. GROUP_PRAYER_COUNTER - Admin can manage
-- ==========================================
DO $$
BEGIN
...
-- ==========================================
-- 9. LIBRARY TABLES - Admin can manage
-- ==========================================
DO $$
BEGIN
...
-- ==========================================
-- 10. FRIENDSHIPS - Admin can view/manage
-- ==========================================
DO $$
BEGIN
...
-- ==========================================
-- 11. APP_SETTINGS - Admin can manage
-- ==========================================
DO $$
BEGIN
...
-- ==========================================
-- 12. DAYS (program) - Admin can manage
-- ==========================================
DO $$
BEGIN
...
-- ==========================================
-- 13. NOTIFICATIONS - Admin can send to all
-- ==========================================
DO $$
BEGIN
...
-- ==========================================
-- DONE! Admin back-office should now work:
-- ✅ Manage users (add, edit role, delete, activate/deactivate)
-- ✅ Manage groups (create, delete, add/remove members, change roles)
-- ✅ Manage prayers (view, lock, mark as answered, delete)
-- ✅ Manage messages (view, delete)
-- ✅ Manage library (add, edit, delete books)
-- ✅ Manage settings & program days
